 ...
 */
final class Version20221020135327 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE examens ADD CONSTRAINT FK_B2E32DD7C2140342 FOREIGN KEY (eleves_id) REFERENCES eleves (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
